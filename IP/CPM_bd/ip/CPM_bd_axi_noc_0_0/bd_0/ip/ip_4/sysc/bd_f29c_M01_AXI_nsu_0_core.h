...
//
//**********************************************************************
#ifndef _bd_f29c_M01_AXI_nsu_0_core_h_
#define _bd_f29c_M01_AXI_nsu_0_core_h_

#include "NOCSlaveUnitXtlm.h"
#include "properties.h"

class bd_f29c_M01_AXI_nsu_0_core : public NOCSlaveUnitXtlm
{
public:
...
bd_f29c_M01_AXI_nsu_0_core( sc_core::sc_module_name nm, const xsc::common_cpp::properties& props )
  ...
  virtual ~bd_f29c_M01_AXI_nsu_0_core() = default;
